...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
       ...
       self.ua1 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; Xiaomi; MI MAX; hydrogen; qcom; ru_RU; {self.kode})'
       self.ua2 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; OnePlus; ONEPLUS A5000; OnePlus5; qcom; ru_UA; {self.kode})'
       self.ua3 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; LGE/google; Nexus 5X; bullhead; bullhead; ru_UA; {self.kode})'
       self.ua4 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; HUAWEI; HUAWEI VNS-L31; HWVNS-H; hi6250; pt_PT; {self.kode})'
